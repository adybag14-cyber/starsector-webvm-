...
public class Duzahk {
	...
	public void addHyperspaceStation(SectorAPI sector) {
		LocationAPI hyper = Global.getSector().getHyperspace();

		SectorEntityToken hyperstation = hyper.addCustomEntity("hyperstation_test", "Hyper Station", "station_mining00", Factions.INDEPENDENT);
