...
public class Galatia {
	...
	public void generate(SectorAPI sector) {
		...
		SectorEntityToken ancyraStation = system.addCustomEntity("ancyra_station", "Ancyra Research Facility", "station_side00", Factions.HEGEMONY);
		...
		debris.getLocation().set(1000, -12000);
