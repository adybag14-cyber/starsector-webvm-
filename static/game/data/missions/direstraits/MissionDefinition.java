...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "kite_Interceptor", FleetMemberType.SHIP, "HSS Gadfly", false).getCaptain().setPersonality(Personalities.CAUTIOUS);
		api.addToFleet(FleetSide.PLAYER, "kite_Interceptor", FleetMemberType.SHIP, "HSS Midge", false).getCaptain().setPersonality(Personalities.CAUTIOUS);
